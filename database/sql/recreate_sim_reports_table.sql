-- Script pour recréer complètement la table sim_reports

-- Supprimer la table existante
DROP TABLE IF EXISTS sim_reports;
...
SELECT COUNT(*) as total_reports FROM sim_reports;
SELECT COUNT(*) as public_reports FROM sim_reports WHERE is_public = 1 AND status = 'published';
