...
<div class="container-fluid">
            ...
            <div class="card-modern p-3">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Créer un nouvel entrepôt dans le système CSAR</p>
                    </div>
                    <div>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="card-modern p-3">
                <form action="{{ route('admin.entrepots.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" id="nom" name="nom" value="{{ old('nom') }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" id="ville" name="ville" value="{{ old('ville') }}" placeholder="Ex: Dakar, Tambacounda, etc." required>
                            </div>
                            
                            <div class="mb-3">
                                <label for="adresse" class="form-label small fw-bold">Adresse complète *</label>
                                <textarea class="form-control form-control-sm" id="adresse" name="adresse" rows="3" required>{{ old('adresse') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control form-control-sm" id="capacite" name="capacite" value="{{ old('capacite') }}" min="1" step="0.01" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-sm" id="unite_capacite" name="unite_capacite" required>
                                    ...
                                    <option value="m²" {{ old('unite_capacite') == 'm²' ? 'selected' : '' }}>m² (mètres carrés)</option>
                                    <option value="m³" {{ old('unite_capacite') == 'm³' ? 'selected' : '' }}>m³ (mètres cubes)</option>
                                    <option value="litres" {{ old('unite_capacite') == 'litres' ? 'selected' : '' }}>Litres</option>
                                    <option value="tonnes" {{ old('unite_capacite') == 'tonnes' ? 'selected' : '' }}>Tonnes</option>
                                    <option value="palettes" {{ old('unite_capacite') == 'palettes' ? 'selected' : '' }}>Palettes</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-sm" id="type" name="type" required>
                                    ...
                                    <option value="depot" {{ old('type') == 'depot' ? 'selected' : '' }}>Dépôt</option>
                                </select>
                            </div>
                            
                            <div class="mb-3">
                                <label for="statut" class="form-label small fw-bold">Statut initial *</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control form-control-sm" id="date_creation" name="date_creation" value="{{ old('date_creation', date('Y-m-d')) }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control form-control-sm" id="latitude" name="latitude" value="{{ old('latitude') }}" step="0.000001" placeholder="Ex: 14.7167">
                            </div>
                        </div>
                        <div class="col-lg-6 mb-3">
                            <div class="mb-3">
                                <label for="longitude" class="form-label small fw-bold">Longitude</label>
                                <input type="number" class="form-control form-control-sm" id="longitude" name="longitude" value="{{ old('longitude') }}" step="0.000001" placeholder="Ex: -17.4677">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" id="responsable" name="responsable" value="{{ old('responsable') }}" required>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <div class="mb-3">
                                <label for="telephone_responsable" class="form-label small fw-bold">Téléphone *</label>
                                <input type="tel" class="form-control form-control-sm" id="telephone_responsable" name="telephone_responsable" value="{{ old('telephone_responsable') }}" placeholder="Ex: 221784257743" required>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <div class="mb-3">
                                <label for="email_responsable" class="form-label small fw-bold">Email *</label>
                                <input type="email" class="form-control form-control-sm" id="email_responsable" name="email_responsable" value="{{ old('email_responsable') }}" placeholder="Ex: responsable@csar.sn" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-sm" id="description" name="description" rows="4" placeholder="Décrivez les caractéristiques particulières de cet entrepôt...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
