...
<head>
    ...
    <title>Mot de passe oublié - Agent CSAR</title>
...
<body>
    <div class="card">
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="agent@csar.sn">
                </div>
            </div>
        ...
        <a class="back" href="{{ $backUrl ?? '/agent/login' }}">
