...
<body>
    <div class="login-container">
        ...
        <form id="loginForm">
            ...
            <button type="submit" class="btn">
                ...
                <span id="loading" class="loading">Connexion...</span>
            </button>
        </form>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', async function(e) {
            ...
            messageDiv.innerHTML = '<div class="alert alert-success">🔄 Connexion en cours...</div>';
            ...
            try {
                ...
                const response = await fetch('/bypass-login', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (response.ok) {
                    ...
                    messageDiv.innerHTML = `<div class="alert alert-danger">❌ ${data.error || 'Erreur de connexion'}</div>`;
                }
            } catch (error) {
                messageDiv.innerHTML = '<div class="alert alert-danger">❌ Erreur de connexion. Vérifiez que le serveur est démarré.</div>';
            } finally {
                // Masquer le loading
