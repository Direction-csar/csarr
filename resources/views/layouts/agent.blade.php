...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/agent-professional.css') }}">
    <link rel="stylesheet" href="{{ asset('css/agent-enhanced.css') }}">
...
<body class="interface-agent">
    {{-- Navbar Mobile --}}
    @include('components.mobile-navbar', ['interface' => 'Agent Terrain'])
    <!-- Particules flottantes -->
    ...
    <!-- Sidebar -->
    <aside class="agent-sidebar sidebar" id="sidebar">
        <!-- Sidebar Header -->
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <!-- Déconnexion -->
                <a href="#" class="nav-item" onclick="event.preventDefault(); document.getElementById('agentLogoutForm').submit();">
    ...
    <script>
    // Wrap tables for horizontal scroll on small screens in agent layout
    (function(){
        const container = document.querySelector('.agent-content');
        if (!container) return;
