...
/**
 * Script final pour nettoyer et unifier MySQL
 */

echo "🧹 Nettoyage final et unification MySQL\n";
echo "======================================\n\n";
...
try {
    ...
    echo "1️⃣ État actuel de la base de données...\n";
    ...
    // 2. Créer des données de base minimales
    echo "2️⃣ Création de données de base minimales...\n";
    ...
    try {
        ...
        echo "   ❌ Erreur contenu public: " . $e->getMessage() . "\n";
    }
    ...
    try {
        ...
        echo "   ❌ Erreur image de fond: " . $e->getMessage() . "\n";
    }
