<?php
/**
 * Script pour créer le fichier .env correctement
 */
...
echo "Base de données configurée : csar_platform\n\n";
echo "Vous pouvez maintenant lancer le serveur avec :\n";
echo "C:\\xampp\\php\\php.exe artisan serve --host=127.0.0.1 --port=8000\n";
?>
